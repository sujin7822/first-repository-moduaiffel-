...
---
깃허브를 깃허브 사이트에서 수정해본 경험은 있지만, 이렇게 Cloud shell로 작성해본 적은 처음이었습니다.
많이 생소했고 어려웠지만, 반복하며 작성하고 수정해보면서 수월해진 것 같습니다.

두 기사를 읽어보며, 인공지능이 이제는 정말 많은 분야에서 활약을 한다는 것을 상기시키게 되었습니다.
아이펠 활동을 하면서 인공지능에 대한 지식을 키워 빠르게 발전하는 인공지능 사회에 걸맞은 사람이 되고자 합니다.
